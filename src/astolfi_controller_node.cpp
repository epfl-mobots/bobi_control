...
#include <bobi_control/astolfi_control.hpp>

using namespace bobi;

int main(int argc, char** argv)
{
    ros::init(argc, argv, "astolfi_controller_node");
    ...
    AstolfiControl ctrl(nh, id, pose_topic, wheel_radius, wheel_distance);

    int rate;
    nh->param<int>("astolfi_control/rate", rate, 30);
